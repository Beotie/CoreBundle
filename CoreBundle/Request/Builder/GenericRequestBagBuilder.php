...
/**
 * Generic request bag builder
 *
 * This class is used to generate a new GenericRequestBag
 *
 * @category Request
 * @package  Beotie_Core_Bundle
 * @author   matthieu vallance <matthieu.vallance@cscfa.fr>
 ...
 * @link     http://cscfa.fr
 */
class GenericRequestBagBuilder implements RequestBagBuilderInterface
{
    /**
     * Data
     *
     * This property store the request data
     *
     * @var mixed
     */
    private $data;
    ...
    {
        return new GenericRequestBag($this->data);
    }
}
